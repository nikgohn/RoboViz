...
export const en = {
  ...
  matlabBaseAnglesInDegreesDescription: 'Use degrees for base rotation (e.g., 90) or symbolic radians (e.g., pi/2).',
  matlabUseNonStandardBase: 'Use non-standard base',
  matlabUseNonStandardBaseDescription: 'Apply the custom base orientation from the Editor page. If off, the base will be at the world origin.',
