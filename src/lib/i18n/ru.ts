...
export const ru = {
  ...
  matlabBaseAnglesInDegreesDescription: 'Использовать градусы для вращения базы (например, 90) или символические радианы (например, pi/2).',
  ...
  matlabJointControlTitle: 'Управление шарнирами',
  matlabPoseX: 'X:',
  matlabPoseY: 'Y:',
  matlabPoseZ: 'Z:',
  matlabPoseRoll: 'Крен:',
